function gen_code_replica!(
    ...
    code_replica[start_sample:num_samples + early_late_samples + start_sample - 1] .= GNSSSignals.get_code.(S, (0 - max_sample_shift:num_samples - 1 + max_sample_shift) .* code_frequency ./ sampling_frequency .+ start_code_phase, prn)
    code_replica
end
